...
<div id="footer">
 ...
 <ul>
  <li class="footNav"><?php if ($this->_tpl_vars['open']['user']): ?><?php if ($this->_tpl_vars['global_user']): ?><a href="<?php echo $this->_tpl_vars['url']['user']; ?>
...
?mobile"><?php echo $this->_tpl_vars['lang']['dou_pc']; ?>
 ...
 <?php if ($this->_tpl_vars['site']['icp']): ?><a href="http://www.beian.miit.gov.cn/" target="_blank"><?php echo $this->_tpl_vars['site']['icp']; ?>
</a><?php endif; ?></li>
 </ul>
</div>
