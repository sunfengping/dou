...
class File {
     ...
     * +----------------------------------------------------------
     */
    function __construct($file_dir = 'images/upload/', $thumb_dir = '', $file_type = 'jpg,jpeg,gif,png,xls,xlsx,pdf,rar,zip', $file_size_max = '2048') {
    ...
    // 构造函数.兼容PHP4
    function File($file_dir = 'images/upload/', $thumb_dir = '', $file_type = 'jpg,gif,png,xls,xlsx,pdf,rar,zip', $file_size_max = '2048') {
