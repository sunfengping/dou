<?php /* Smarty version 2.6.26, created on 2019-03-20 23:25:43
...
<div id="wrapper">
 ...
 <div class="license">
  <form action="" method="post">
   <ul>
    <textarea name="request" cols="90" rows="15" readonly="readonly">© 2013-2019 漳州豆壳网络科技有限公司。保留所有权利。
...
三、协议规定的约束和限制
1.未获商业授权之前，不得删除网站底部及相应的官方版权信息和链接。DouPHP著作权已在中华人民共和国国家版权局注册(中国国家版权局著作权登记号 2013SR122168)，著作权受到法律和国际公约保护 。购买商业授权请登陆www.dou.co了解最新说明。
2.未经官方许可，不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。
3.不管您的网站是否整体使用 DouPHP ，还是部份栏目使用 DouPHP，在您网站页面页脚处的 Powered by DouPHP 名称和 http://www.dou.co 的链接都必须保留且不能修改。
...
DouPHP 的官方网址是：www.dou.co 交流论坛：bbs.douco.cn</textarea>
    <div class="agree">
     <label>
