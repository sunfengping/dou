...
$_LANG['cloud_frame_cue'] = '这个功能需要 iframe 的支持。您可能禁止了 iframe 的显示，或您的浏览器不支持此功能。'; // 提示信息
$_LANG['cloud_pay_fail'] = '付款失败';
$_LANG['cloud_pay_success'] = '付款成功';
$_LANG['cloud_unzip_ing'] = '正在解压缩安装包…'; // TEP.解压缩
$_LANG['cloud_unzip_wrong'] = '压缩包解压失败';
$_LANG['cloud_down_ing_0'] = '正在从 '; // TEP.下载
$_LANG['cloud_down_ing_1'] = ' 下载安装包…';
$_LANG['cloud_down_wrong'] = '下载失败';
$_LANG['cloud_install_ing'] = '正在安装 '; // TEP.安装
