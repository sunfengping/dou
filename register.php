...
if(count($user)>0){ 
	...
	$product = $dou->fn_query("INSERT INTO 58_admin (user_name,email,`password`,action_list,add_time,last_login,last_ip,type,card_id,mobile,`status`,truename,bankno) VALUES ('".$name."', ' ', '".$password."',' ',unix_timestamp(now()),0,'','2','".$cardno."','".$phoneno."',0,'".$truename."',".$bankno.")");
